...
var countDownDate = new Date("Feb 27, 2018 09:00 GMT+08:00").getTime();
...
var x = setInterval(function() {
  ...
  document.getElementById("demo").innerHTML = "<strong><br>Gasoline on the fire in: " + hours + "h "
  + minutes + "m " + seconds + "s</strong>";

  // If the count down is finished, write some text 
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("demo").innerHTML = "Let her rip, boys!";
  }
}, 1000);
</script>
